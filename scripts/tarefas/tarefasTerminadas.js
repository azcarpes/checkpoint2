...
function mostraTarefasTerminadas(tarefa) {
    ...
    liTarefas.innerHTML =
        ...
        <img id="enviarPendente" src="/ToDo-App/assets/reload.png" onclick="alterarStatus(${tarefa.id}, '${tarefa.description}', ${tarefa.completed})" onclick="mostraTarefasPendentes()">
